    ...
    def admit_stage(self, stage: str, ctx: RequestContext) -> StageRouteDecision:
        ...
        req = AgentRequest(
            ...
            metadata={
                ...
                "workflow_id": ctx.workflow_id,
                "preferred_worker_id": self._preferred_worker_for(ctx.workflow_id) if stage == "prefill" else None,
                "stage": stage,
                "preferred_pool": self._preferred_pool_for_stage(stage, ctx),
                "avoid_pool": self._avoid_pool_for_stage(stage, ctx),
                "preferred_worker_ids": self._preferred_workers_for_stage(stage, ctx),
